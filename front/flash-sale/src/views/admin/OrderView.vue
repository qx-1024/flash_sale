<template>
    <el-button class="addBtn" :icon="Plus" @click="add" size="small" round>添 加 订 单</el-button>
    ...
    <el-table :data="tableData" stripe style="width: 100%" v-else>
        <el-table-column prop="orderId" align="center" label="订单ID" show-overflow-tooltip/>
        ...
        <el-table-column prop="activityName" align="center" label="闪购活动" show-overflow-tooltip/>
        <el-table-column prop="amount" align="center" label="订单总价" show-overflow-tooltip/>
        <el-table-column prop="orderStatus" align="center" label="订单状态" show-overflow-tooltip/>
        <el-table-column prop="payStatus" align="center" label="支付状态" show-overflow-tooltip/>
        <el-table-column prop="shippingStatus" align="center" label="运输状态" show-overflow-tooltip/>
        ...
        <el-table-column prop="options" align="center" fixed="right" label="操作" width="180">
            <template #default="scoped">
                <el-button class="editBtn" :icon="Edit" size="small" @click="view(scoped.row.id)" round>编 辑</el-button>
                <el-button class="delBtn" :icon="Delete" size="small" @click="del(scoped.row.id)" round>删 除</el-button>
            </template>
        </el-table-column>
    </el-table>
