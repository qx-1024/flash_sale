<template>
    <el-button class="mybtn" :icon="Plus" @click="add" size="small" round>添 加 商 品</el-button>
    <img class="empty_data_img" src="../../assets/empty_data.svg" alt="空空如也~" v-if="tableData.length == 0">
    <el-table :data="tableData" stripe style="width: 100%; max-height: 610px;" v-else>
        <el-table-column prop="productName" align="center" label="商品名称" show-overflow-tooltip/>
        <el-table-column prop="price" align="center" label="价格"/>
        <el-table-column prop="stock" align="center" label="库存"/>
        <el-table-column prop="sales" align="center" label="销量"/>
        <el-table-column prop="images" align="center" label="图片" show-overflow-tooltip>
            <template v-slot="scope">
                <img :src="scope.row.images" style="width: 50px; height: 50px;" alt="盗图必究">
            </template>
        </el-table-column>
        <el-table-column prop="createTime" align="center" label="添加时间" :formatter="formatDate" show-overflow-tooltip/>
        ...
        <el-table-column prop="options" align="center" fixed="right" label="操作" width="180">
            <template #default="scoped">
                <el-button type="success" :icon="Edit" size="small" @click="edit(scoped.row.productId)" plain round>编 辑</el-button>
                <el-button type="danger" :icon="Delete" size="small" @click="del(scoped.row.productId)" plain round>删 除</el-button>
            </template>
        </el-table-column>
    </el-table>
    ...
    <el-dialog v-model="editDialogVisible" title="编辑商品" width="500" center>
        <el-form ref="editRefForm" :model="editProductForm" :rules="productRules" label-width="auto" style="max-width: 600px">
            ...
            <el-form-item label="是否参与闪购">
                <el-select v-model="editProductForm.isFlashSale" placeholder="请选择是否参与闪购">
    ...
    <el-dialog v-model="addDialogVisible" title="新增商品" width="500" center>
        <el-form ref="addRefForm" :model="addProductForm" :rules="productRules" label-width="auto" style="max-width: 600px">
            <el-form-item label="商品名称" prop="productName">
            ...
            <el-form-item label="是否参与闪购">
                <el-select v-model="addProductForm.isFlashSale" placeholder="请选择是否参与闪购">
                    <el-option label="是" value="1" />
                    <el-option label="否" value="0" />
                </el-select>
            </el-form-item>
...
import { Plus, Delete, Edit, View, UploadFilled } from '@element-plus/icons-vue'
import { ElMessage } from 'element-plus'
import { doDelete, doGet, doPost, doPut, uploadFile } from "../../http/httpRequest";
