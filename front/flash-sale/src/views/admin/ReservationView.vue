    ...
    <el-table :data="tableData" stripe style="width: 100%" v-else>
        ...
        <el-table-column prop="options" align="center" fixed="right" label="操作" width="180">
            <template #default="scoped">
                <el-button type="success" :icon="Edit" size="small" @click="view(scoped.row.reservationId)" plain round>编 辑</el-button>
                <el-button type="danger" :icon="Delete" size="small" @click="del(scoped.row.reservationId)" plain round>删 除</el-button>
            </template>
        </el-table-column>
    </el-table>
