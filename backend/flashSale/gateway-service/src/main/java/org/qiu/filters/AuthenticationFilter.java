...
public class AuthenticationFilter implements GlobalFilter {
     ...
     * 判断是否为需要排除的 URI
     */
    private boolean isNotExcludedUri(String uriStr) {
        return  !uriStr.equals(Constants.USER_LOGIN_URI) &&
     ...
     */
    private void applyRateLimit(ServerHttpRequest request,
